...
//	Calendar cal = Calendar.getInstance();
    ...
    /**
     * 写文本文件，文件放置在com.nht/files目录下
     *
     * @param fileName 操作文件名
     * @param writestr 写入字符串内容
     * @param context  页面context对象
     */
    public static void WriteTextFile(String fileName, String writestr,
    ...
    /**
     * 读文本文件，文件放置在com.nht/files目录下
     *
     * @param fileName 操作文件名
     * @param context  页面context对象
     * @return 读取出来的字符串内容
     */
    public static String ReadTextFile(String fileName, Context context)
            throws IOException {
        String res = "";
        try {
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    Log.e("FunctionHelper", e.toString());
                }
            }
        }.start();
    }
    ...
    public static boolean isPhoneNo(String phoneNo) {
        String strRegex = "^((13[0-9])|(14[0-9])|(15[0-9])|(17[0-9])|(18[0-9]))\\d{8}$";
        boolean result = patternMatcher(phoneNo, strRegex);
        return result;
    }
