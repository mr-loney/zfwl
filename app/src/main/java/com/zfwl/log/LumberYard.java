...
public final class LumberYard {
    ...
    private LumberYard(Application app) {
        this.app = app;
    }

    public static LumberYard getInstance() {
        if (sInstance == null) {
            sInstance = new LumberYard(ZfwlApplication.APP_CONTEXT);
        }
        return sInstance;
    }
    ...
    public Observable<File> save() {
        return Observable.create(new Observable.OnSubscribe<File>() {
            ...
            public void call(Subscriber<? super File> subscriber) {
                ...
                String fileName = TimeUtils.millisToTimestamp(System.currentTimeMillis(), "yyyy-MM-dd");
