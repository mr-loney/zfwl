package com.zfwl.controls.refreshlayout;
...
public class SwipeRefreshLayoutEx extends SwipeRefreshLayout implements IRefreshLayout {
    ...
    private void handleChildView() {
        ...
        if (mChildView instanceof RecyclerView) {
            final RecyclerView rv = (RecyclerView) mChildView;
            rv.addOnScrollListener(new RecyclerView.OnScrollListener() {
                @Override
                public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                    super.onScrollStateChanged(recyclerView, newState);
                    canScrollDown(recyclerView, newState);
                }
    ...
    private void canScrollDown(View view, int scrollState) {
        if (scrollState == RecyclerView.SCROLL_STATE_IDLE && !mIsRefreshing && !mIsLoadingMore
