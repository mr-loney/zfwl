...
import com.zfwl.library.event.OnTitleBarClickListener;
...
public class TitleBar extends RelativeLayout {
	...
	private void InitTitleBar(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			rightButtonText = a.getString(R.styleable.TitleBar_RightButtonText);
			rightButtonImage = a
					.getDrawable(R.styleable.TitleBar_RightButtonImage);
			isImgButton = a.getBoolean(R.styleable.TitleBar_IsImgButton, false);
			showBackButton = a.getBoolean(R.styleable.TitleBar_ShowBackButton,
					false);
			showLeftMenuButton = a.getBoolean(
					R.styleable.TitleBar_ShowLeftMenuButton, false);
			showRightButton = a.getBoolean(
					R.styleable.TitleBar_ShowRightButton, false);

			showRigthMoreimage = a
					.getDrawable(R.styleable.TitleBar_showRigthMoreimage);
		}
		// 标题
