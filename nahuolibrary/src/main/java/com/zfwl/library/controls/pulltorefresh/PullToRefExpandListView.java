...
import com.zfwl.library.event.OnListViewItemClickListener;

public class PullToRefExpandListView extends ExpandableListView implements OnScrollListener {
...
//    private ProgressBar        mProgressBar;
    ...
    public PullToRefExpandListView(Context pContext) {
        super(pContext);
        init(pContext, null);
    }

    public PullToRefExpandListView(Context pContext, AttributeSet pAttrs) {
        super(pContext, pAttrs);
        init(pContext, pAttrs);
    }

    public PullToRefExpandListView(Context pContext, AttributeSet pAttrs, int pDefStyle) {
